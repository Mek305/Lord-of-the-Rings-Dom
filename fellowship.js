...
function keepItSecretKeepItSafe() {
  ...
  let $divv = document.createElement('div');
   $divv.setAttribute('id','the-Ring')
  // give the div a class of 'magic-imbued-jewelry'
  divv.className = 'magic-imbued-jewelry'
  // add the ring as a child of Frodo1 
...
function beautifulStranger() {
  ...
  for(var e = 0; e < buddies.length; e++){
    if(buddies[e] == "Strider"){
      buddies[e].innerHTML = "Aragorn"
    }
  }
